...
export const CLUES: ClueDef[] = [
  ...
  {
    id: 'forsythe_signet',
    label: 'A tarnished signet ring',
    position: { x: 4, y: 1.0, z: 14 },
    check: { ability: 'int', skill: 'history', dc: 13 },
    reveals: ['forsythe'],
    flavorOnFind: "A ring dropped in the corner of the study. The crest is half-rubbed away.",
    flavorOnSuccess: "Forsythe Forewater's house crest. He has been in this room recently.",
    flavorOnFail: "Old ring. Could be any noble's.",
    color: 0x99aaff,
  },
  {
    id: 'cellar_blood',
    label: 'Blood stain on a stone',
    position: { x: 44, y: 1.0, z: 28 },
    check: { ability: 'wis', skill: 'medicine', dc: 14 },
    reveals: ['freelance', 'assassin_guild'],
    flavorOnFind: 'A small, irregular splatter near the storage entrance.',
    flavorOnSuccess: "Not fresh. Days old. Someone bled here before tonight — the assassin was scouting.",
    flavorOnFail: 'A stain. Wine, probably.',
    color: 0x884422,
  },
  {
    id: 'cult_brand',
    label: 'A burnt cloth scrap',
    position: { x: 17, y: 1.0, z: 38 },
    check: { ability: 'int', skill: 'religion', dc: 12 },
    reveals: ['sea_goddess'],
    flavorOnFind: 'A black cloth corner half-buried in the herb beds.',
    flavorOnSuccess: 'The brand of Umberlee\'s drowned chorus. The Cult\'s mark.',
    flavorOnFail: 'Burned cloth. Possibly from the kitchen.',
    color: 0x66ccff,
  },
  {
    id: 'whispering_tome',
    label: 'A tome that whispers',
    position: { x: 32, y: 6.5, z: 24 },
    check: { ability: 'int', skill: 'arcana', dc: 15 },
    reveals: ['sentient_sword', 'unseelie'],
    flavorOnFind: 'A library tome turning its own pages.',
    flavorOnSuccess: 'The book identifies Sunder by name and warns of the Unseelie geas chain in the same paragraph.',
    flavorOnFail: 'You shut it and step back.',
    color: 0xaa66dd,
  },
];
